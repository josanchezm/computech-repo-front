const MainProducts = () => {
    return (
        <main>
            ...
            <section>
                <p>Computech</p>
                <h2>No esperes más, encuentra tu nuevo ordenador hoy!</h2>
                <p>
                ...
                <p>
                    <span>$2,733,000</span>
                    <span><img src="" alt="Icono descuento" /> 5%</span>
                </p>
                <div>
                    <div>
                        <button>-</button>
                    ...
                    <button><img src="" alt="Icono carrito de compras" /> Agregar al carrito</button>
                </div>
            </section>
        </main>
    );
